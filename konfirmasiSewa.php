            ...
            <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
                ...
                <div class="sidebar-collapse menu-scroll">
                    <ul id="side-menu" class="nav">
                        ...
                        <li class="active" ><a href="konfirmasiSewa.php"><i class="glyphicon glyphicon-check">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left">
                        <div class="page-title">Konfirmasi Sewa</div>
                    </div>
                    <div class="clearfix">
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="panel panel-blue">
                                <div class="panel-heading">Table Sewa</div>
                                <div class="panel-body">
                                    <table class="table table-hover">
                                        ...
                                        <!--u.nama_lengkap,mulaiSewa,akhirSewa,harga,status-->
                                        <?php
                                        $query = mysql_query("select * from sewa s join user u on s.idUser=u.idUser join data_rumah r on s.tipe_rumah=r.tipe_rumah;");
                                        $sql = mysql_query("SELECT year(akhirSewa)-YEAR(mulaiSewa) as lama FROM `sewa`");
                                        $no = 1;
                                        while ($data = mysql_fetch_array($query)) {
                                            $tahun = mysql_fetch_array($sql);
                                            ?>
                                            <tbody>
                                                <tr>
                                                    <td><?php echo $no; ?></td>                                                  
                                                    ...
                                                    <td><?php echo $data['mulaiSewa']; ?></td>
                                                    <td><?php echo $data['akhirSewa']; ?></td>
                                                    <td><?php
                                                        $harga = $data['harga'] * $tahun['lama'];
                                                        $bayar = $data['bayar'];
                                                        if ($bayar < $harga) {
                                                            $kurang = $harga - $bayar;
                                                            echo $kurang;
                                                        } else if ($harga == $bayar || $bayar > $harga) {
                                                            echo 'Lunas';
                                                        }
                                                        ?>
                                                    </td>
                                                    <td><?php
                                                        if ($data['status'] == 0) {
                                                            echo '<span class="label label-sm label-info">Pending</span>';
                                                        } else {
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary" href="konfirmasiBayar.php?id=<?php echo $data['idTransaksi'] ?>">
                                                            <abbr title="Konfirmasi Sewa dan Bayar">
                                                                <i class="fa fa-check">      
                                                                </i>  
                                                            </abbr>   
                                                        </a>
