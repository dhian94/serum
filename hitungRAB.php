                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                ...
                                                                <input id="inputHT" type="text" placeholder="Harga Tanah/M^2" class="form-control" name="hTanah" required=""/></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <!--<i class="glyphicon glyphicon-usd"></i>-->
                                                                <input id="inputLT" type="text" placeholder="Luas Tanah (M^2)" class="form-control"name="lTanah" required=""/></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <!--<i class="glyphicon glyphicon-usd"></i>-->
                                                                <input id="inputHB" type="text" placeholder="Harga Bangun Rumah/M^2" class="form-control" name="hBangun"required=""/></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <!--<i class="glyphicon glyphicon-usd"></i>-->
                                                                <input id="inputLB" type="text" placeholder="Luas Rumah (M^2)" class="form-control" name="lBangun"required=""/></div>
                                                        </div>
                                                    </div>
<!--                                                    <div class="col-md-12">
                                                        <div class="form-group">
