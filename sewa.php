            ...
            <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
                ...
                <div class="sidebar-collapse menu-scroll">
                    <ul id="side-menu" class="nav">
                        ...
                        <li class="active"><a href="sewa.php"><i class="glyphicon glyphicon-shopping-cart">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                ...
                                                                <input id="inputTglAwal" type="text" placeholder="Tanggal Mulai Sewa" class="form-control" name="tgl" required=""/></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control" name="tipe">
                                                                ...
                                                                while ($data = mysql_fetch_array($query)) {
                                                                    ?>
                                                                    <option value="<?php echo $data['tipe_rumah']; ?>"><?php echo $data['nama_gambar']; ?></option>
                                                                <?php }
                                                                ?>
                                                            </select>
                                                        </div>
