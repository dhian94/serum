        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="page-content">
                    <?php
                    $id = $_GET['id'];
                    $query = mysql_query("select * from user where idUser=$id;");
                    $data = mysql_fetch_array($query);
                    ?>
                    <form method="post" action="model/registerUser.php?id=<?php echo $id ?>">
                        <!--<div class="page-content">-->
                        <div class="col-lg-12">
                            <div class="row">
                                            ...
                                            <div class="form-body pal">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                ...
                                                                <input id="inputID" type="text" name="id" value="<?php $id ?>" class="hidden" />
                                                                <input id="inputName" type="text" name="username" value="<?php echo $data['username'] ?>" class="form-control" required=""/></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                ...
                                                                <input id="inputPassword" type="password" name="password" value="<?php echo $data['password'] ?>" class="form-control" required=""/></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <input id="inputNamaLengkap" type="text" name="namaLengkap" value="<?php echo $data['nama_lengkap'] ?>" class="form-control" required=""/></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <input id="inputNoKTP" type="text" name="noKTP" value="<?php echo $data['noKTP'] ?>" class="form-control" required=""/></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                ...
                                                                <input id="inputNoPe" type="text" name="noHP" value="<?php echo $data['noHP'] ?>" class="form-control" required=""/></div>
                                                            <span id="errmsg"></span>
                                                        </div>
                                                    </div>
                                                </div>                      
                                                ...
                                                <div class="form-group mbn">
                                                    <textarea rows="3"  name="alamat" class="form-control"><?php echo $data['alamat'] ?></textarea></div>
                                            </div>
