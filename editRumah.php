            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left">
                        <div class="page-title">Edit Rumah</div>
                    </div>
                    <div class="clearfix">
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="panel panel-violet">
                                ...
                                <div class="panel-body pan">
                                    <?php
                                    $tipe = $_GET['tipe'];
                                    $query = mysql_query("select tipe_rumah,luas_rumah, harga, stok, deskripsi from data_rumah where tipe_rumah=$tipe;");
                                    $data = mysql_fetch_array($query);
                                    ?>
                                    <form action="model/mInputRumah.php?tipe=<?php echo $data['tipe_rumah'] ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-icon right">
                                                            ...
                                                            <input id="inputTipeRumah" type="text"  class="form-control" value="<?php echo $data['tipe_rumah'] ?>" readonly name="tipe"/></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-icon right">
                                                            ...
                                                            <input id="inputLuasTanah" type="text"  class="form-control" value="<?php echo $data['luas_rumah']?>" readonly name="luas"/></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-icon right">
                                                            <!--<i class="fa fa-phone"></i>-->
                                                            <input id="inputHargaRumah" type="text" placeholder="Harga Rumah" class="form-control" value="<?php echo $data['harga']?>"  required="" name="harga"/></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-icon right">
                                                            <!--<i class="fa fa-phone"></i>-->
                                                            <input id="inputStokRumah" type="text" placeholder="Stok Rumah" class="form-control" value="<?php echo $data['stok']?>" required="" name="stok"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr />
                                            <div class="form-group mbn">
                                                <textarea rows="5"  class="form-control" readonly name="deskripsi"><?php echo $data['deskripsi']?> </textarea></div>
                                        </div>
