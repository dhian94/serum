            ...
            <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
                ...
                <div class="sidebar-collapse menu-scroll">
                    <ul id="side-menu" class="nav">
                        ...
                        <li><a href="gallery.php"><i class="glyphicon glyphicon-picture">
                                </i><span class="menu-title"> Gallery</span></a>
                        </li>
                        <li class="active"><a href="hitungRAB.php"><i class="glyphicon glyphicon-usd">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left">
                        <div class="page-title">Hitung RAB</div>
                    </div>
                    <div class="clearfix">
                    </div>
                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="panel panel-red">
                                    ...
                                    <div class="panel-body pan">
                                        <form action="model/mHitungRAB.php" method="post">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                ...
                                                                <input id="inputHT" type="text" value="<?php echo $_SESSION['hargaT']; ?>" class="form-control" name="hTanah" readonly=""/></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <!--<i class="glyphicon glyphicon-usd"></i>-->
                                                                <input id="inputLT" type="text" value="<?php echo $_SESSION['luasT']; ?>" class="form-control"name="lTanah" readonly=""/></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <!--<i class="glyphicon glyphicon-usd"></i>-->
                                                                <input id="inputHB" type="text" value="<?php echo $_SESSION['hargaB']; ?>" class="form-control" name="hBangun"readonly=""/></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <!--<i class="glyphicon glyphicon-usd"></i>-->
                                                                <input id="inputLB" type="text" value="<?php echo $_SESSION['luasB']; ?>" class="form-control" name="lBangun" readonly=""/></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                ...
                                                                <span class="uneditable-input">
                                                                    <input id="Hasil" type="text" value="<?php echo $_SESSION['hasil']; ?>" class="form-control" readonly=""/>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-actions text-right pal">
                                                <a href="hitungRAB.php" class="btn btn-primary">
                                                    Back</a>
                                            </div>
                                        </form>
                                    </div>
